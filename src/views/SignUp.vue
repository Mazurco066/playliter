  ...
  <div id="sign-up">
    <div class="container">
      <div class="auth-wrapper">
        ...
        <div class="row pt-3">
          <div class="col-12 ">
            <h4 class="title text-white">{{ $t('signup.title') }}</h4>
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-12">
              <div class="d-flex justify-content-center align-items-center mb-3">
                ...
                <router-link to="signin" class="auth-action text-secondary-light">
                  {{ $t('signup.pageLink') }}
                </router-link>
              </div>
            </div>
      ...
      <div class="row">
        <div class="col-12">
          <p class="text-center">
            {{ $t('home.version') }} <strong class="text-secondary-light">3.0.0</strong>
          </p>
        </div>
      </div>
    </div>
